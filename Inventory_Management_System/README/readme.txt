...
Required Elements:
- Strings
    -Throughout my project I used many string and even cases where I had to use the string librarys functionalities.
    -Ex. In the AutoPart class I used the string char indexing feature to grab a letter from input.

- Classes and Constructors
    -I have 5 classes and used seperate compilation to create these classes.
    -My in my Products class there is a non-default constructor, in my Emplyees class I have both a non-default and a default constructor, and the rest of my program I had non default constructures mainly because I felt the information inputted there is only one required attribute the ID.
...
- Inheritance / Polymorphism and Composition/Aggregation/Initialization Lists
    -Inheritance: my BulkLiquid, AutoPart, and Service classes are children of my products class and took advantage of protected access modifers.
    ...
    -Initialization Lists: Since I used inheritence and polymorphism all throught my program most constructors have a initialization list.
...
- Exception Handing
    - Since we are mass including employess there are exceptions that will be thrown making it impossible to use but I handled them with a try catch system.
